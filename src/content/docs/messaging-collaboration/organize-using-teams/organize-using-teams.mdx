---
permalink: /end-user-guide/collaborate/organize-using-teams
...
الفريق هو [مساحة عمل رقمية](/end-user-guide/end-user-guide-index) تتيح لك ولزملائك التعاون داخل Mattermost. اعتماداً على إعدادات مؤسستك، يمكنك الانتماء إلى فريق واحد أو عدة فرق، وقد يكون الوصول إلى الفريق مفتوحاً للجميع أو مقيداً.

---

### 🔗 روابط سريعة
* [إعدادات الفريق](/end-user-guide/collaborate/team-settings)
* [اختصارات لوحة المفاتيح الخاصة بالفرق](/end-user-guide/collaborate/team-keyboard-shortcuts)
...
**هل تحتاج للمساعدة؟**
اتصل بمسؤول النظام في مؤسستك أو راجع [دليل تسجيل الدخول](/end-user-guide/access/access-your-workspace).